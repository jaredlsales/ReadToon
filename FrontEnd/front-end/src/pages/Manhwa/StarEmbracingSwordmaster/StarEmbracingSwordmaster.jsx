...
export default function StarEmbracingSwordmaster() {
  ...
  useEffect(() => {
    async function loadManhwa() {
      try {
        ...
        const dados = response.data.find((m) => m.titulo === "Star-Embracing Swordmaster");
        setManhwa(dados);
        ...
        <div className="grid grid-cols-1 min-[882px]:grid-cols-[1fr_30%] gap-8">
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              {/* TopBar de navegação */}
              <TopBar manhwaTitle={manhwa?.titulo || "Star-Embracing Swordmaster"} />
            ...
            <div className="space-y-4">
              ...
              <Scrollbar
                ...
                manhwaTitle={manhwa?.titulo || "Star-Embracing Swordmaster"}
