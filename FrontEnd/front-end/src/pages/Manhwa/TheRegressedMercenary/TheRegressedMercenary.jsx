  ...
  useEffect(() => {
    async function loadManhwa() {
      try {
        ...
        const dados = response.data.find((m) => m.titulo === "The Regressed Mercenary's Machinations");
        setManhwa(dados);
        ...
        <div className="grid grid-cols-1 min-[882px]:grid-cols-[1fr_30%] gap-8">
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              {/* TopBar de navegação */}
              <TopBar manhwaTitle={manhwa?.titulo || "The Regressed Mercenary's Machinations"} />
            ...
            <div className="space-y-4">
              ...
              <Scrollbar
                capitulos={capitulos}
                slug="the-regressed-mercenary's-machinations"
                manhwaTitle={manhwa?.titulo || "The Regressed Mercenary's Machinations"}
