...
export default function InfiniteMage() {
  ...
  useEffect(() => {
    async function loadManhwa() {
      try {
        ...
        const dados = response.data.find((m) => m.titulo === "Infinite Mage");
        setManhwa(dados);
        ...
        <div className="grid grid-cols-1 min-[882px]:grid-cols-[1fr_30%] gap-8">
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              {/* TopBar de navegação */}
              <TopBar manhwaTitle={manhwa?.titulo || "Infinite Mage"} />
            ...
            <div className="space-y-4">
              ...
              <Scrollbar
                capitulos={capitulos}
                slug="infinite-mage"
                manhwaTitle={manhwa?.titulo || "Infinite Mage"} 
